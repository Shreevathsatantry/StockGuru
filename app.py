...
if page == "Login":
    ...
    if "logged_in" in st.session_state and st.session_state.logged_in:
        google_news.show_page()  # New call
    ...
    if "logged_in" in st.session_state and st.session_state.logged_in:
        information.show_page()  # Show Dashboard page if logged in
    else:
        st.error("You need to log in first!")
elif page == "Stock Research Chat":
    if "logged_in" in st.session_state and st.session_state.logged_in:
        Research_chat.show_page()  # Show Dashboard page if logged in
    else:
        st.error("You need to log in first!")
elif page == "StockGuru Chat":
    if "logged_in" in st.session_state and st.session_state.logged_in:
        StockGuru_chat.show_page()  # Show Dashboard page if logged in
    else:
        st.error("You need to log in first!")
